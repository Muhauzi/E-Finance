        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Tambah Saldo</h4>
                </div><!-- end card header -->

                <div class="card-body d-flex justify-content-center mt-3" style="min-height: 100vh;">
                    <form action="{{ route('keuangan.saldo.store') }}" method="POST" class="col-lg-6">
                        @csrf
                        @method('POST')
                        <div class="row mb-3">
                            <div class="col-lg-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-3">
                                <label for="nameInput" class="form-label">Nama Akun</label>
                            </div>
                            <div class="col-lg-9">
                                <select class="form-control" data-choices data-choices-search="true" name="account_id"
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-primary">
                                ...
                                Simpan</button>
                            <a href="{{ route('keuangan.saldo') }}" class="btn btn-secondary">
