        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Edit Pemasukan</h4>
                </div><!-- end card header -->

                <div class="card-body d-flex justify-content-center mt-3" style="min-height: 100vh;">
                    <form action="{{ route('keuangan.pemasukan.update', $pemasukan->id) }}" method="POST" class="col-lg-6">
                        @csrf
                        @method('POST')
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group mb-3">
                                    <input type="date" class="form-control" name="tanggal" value="{{ old('tanggal', $pemasukan->tanggal) }}">
                                </div>
                                @error('tanggal')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="sumber_pemasukan" value="{{ old('sumber_pemasukan', $pemasukan->sumber_pemasukan) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control" data-choices data-choices-search="true" name="id_detail_account"
                                    ...
                                    <option value="{{ $item->id }}" {{ old('id_detail_account', $pemasukan->id_detail_account) == $item->id ? 'selected' : '' }}>{{ $item->kode_akun . ' | ' . $item->nama_akun }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nominal" aria-label="Satuan Rupiah" value="{{ old('nominal', $pemasukan->nominal) }}">
                                </div>
                                @error('nominal')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group mb-3">
                                    <h5 id="saldo_akhir">Rp.{{ number_format($pemasukan->nominal, 0, ',', '.') }}</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group mb-3">
                                    <textarea class="form-control" name="keterangan" rows="3">{{ old('keterangan', $pemasukan->keterangan) }}</textarea>
                                </div>
                                @error('keterangan')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
