    ...
    <x-page-title>
        ...
        <div class="page-title-right">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active">Input Data Pengajuan</li>
            </ol>
        </div>
    </x-page-title>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body d-flex justify-content-left mt-3" style="min-height: 100vh;">
                    <form action="{{ route('karyawan.pengajuan.store_detail') }}" method="POST">
                        @csrf
                        @method('POST')
                        <input type="hidden" name="pengajuan_dana_id" value="{{ $id }}">
                        <div class="col-lg-12">
