        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Data Account</h4>
                </div><!-- end card header -->
                        ...
                        <div class="row g-4 mb-3">
                            ...
                            <div class="col-sm">
                                <div class="d-flex justify-content-sm-end">
                                    <a href="{{ route('admin.account.create')}}" type="button" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Input Account</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table align-middle table-nowrap" id="customerTable">
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr>
                                        ...
                                        <td class="nama_akun">{{ $item->nama_group_akun }}</td>
                                        <td class="keterangan">{{ $item->keterangan }}</td>
                                        <td class="aksi">
                                            <a href="{{ route('admin.account.edit', $item->id) }}" class="btn btn-sm btn-warning">
                                            <i class="ri-pencil-fill me-1"></i></a>
                                            <form action="{{ route('admin.account.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
