    ...
    <x-page-title>
        ...
        <div class="page-title-right">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active">Input Account</li>
            </ol>
        </div>
    </x-page-title>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body d-flex justify-content-center mt-3" style="min-height: 100vh;">
                    <form action="{{ route('admin.account.store') }}" method="POST" class="col-lg-6">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="nama_group_akun">
                            </div>
                        </div>
